...
impl Icon {
    pub fn name(self) -> &'static str {
        match self {
            ...
            Self::Scanner => "From scanner or camera",
            Self::Wallpaper => "Set as desktop background",
            Self::Properties => "Properties",
            Self::About => "About Paint 10",
            Self::Exit => "Exit",
            Self::Save => "Save",
            Self::Png => "PNG picture",
            Self::Jpeg => "JPEG picture",
            Self::Bitmap => "BMP picture",
            Self::Gif => "GIF picture",
            Self::OtherFormats => "Other picture formats",
            Self::Undo => "Undo",
            Self::Redo => "Redo",
            Self::Paste => "Paste",
            Self::Cut => "Cut",
            ...
            Self::Adjustments => "Image adjustments",
            Self::Grayscale => "Grayscale",
            Self::Invert => "Invert colors",
            Self::ResetImage => "Reset image",
